 ...
 */
/**
 * Clase RetiroQuechua que representa la interfaz de retiro de dinero.
 */
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
         if (!txtRetiro.getText().equals("")) { // Verifica si el campo de retiro no está vacío
            if (Double.parseDouble(txtRetiro.getText()) < (saldo(numeroCuenta))) { // Verifica si el monto a retirar es menor que el saldo disponible
                ...
                Factura factura = new Factura(usuario, numeroCuenta, "Retiro", Double.parseDouble(txtRetiro.getText())); // Crea una instancia de la factura
                factura.setVisible(true); // Hace visible la factura
                factura.setLocationRelativeTo(null); // Centra la factura en la pantalla
                dispose(); // Cierra la ventana actual
            } else {
                JOptionPane.showMessageDialog(null, "Ñawi rikch'aqa.", "llamk'ay", JOptionPane.INFORMATION_MESSAGE); // Muestra un mensaje de saldo insuficiente
            }
        } else {
            JOptionPane.showMessageDialog(null, "Munani qhipa yuraq rikch'a t'ikrachiy", "llamk'ay", JOptionPane.INFORMATION_MESSAGE); // Muestra un mensaje de ingreso de monto
        }
