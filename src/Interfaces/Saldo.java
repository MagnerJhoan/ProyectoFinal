...
public class Saldo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtSaldo.setText("$$$");
        jPanel1.add(txtSaldo, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 260, 90, 50));
        ...
        txtMoneda.setText("$$$");
        jPanel1.add(txtMoneda, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 260, 90, 50));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        Menu ventana = new Menu(usuario,numeroCuenta); // Crea una instancia de la ventana del menú principal
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
         Finish ventana = new Finish(usuario,numeroCuenta); // Crea una instancia de la ventana de finalización
        ...
        Factura factura =new Factura(usuario,numeroCuenta,"Consulta saldo",saldo); // Crea una instancia de la factura
