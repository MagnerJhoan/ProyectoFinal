 ...
 */
/**
 * Clase SaldoQuechua que representa la interfaz para consultar el saldo.
 */
public class SaldoQuechua extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtSaldo.setText("$$$");
        jPanel1.add(txtSaldo, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 250, 70, 50));
        ...
        txtMoneda.setText("$$$");
        jPanel1.add(txtMoneda, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 250, 100, 50));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
         FinishQuechua ventana = new FinishQuechua(usuario,numeroCuenta); // Crea una instancia de la ventana de finalización
        ...
        FacturaQuechua factura =new FacturaQuechua(usuario,numeroCuenta,"Consulta saldo",saldo); // Crea una instancia de la factura
