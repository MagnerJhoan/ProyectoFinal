 ...
 */
/**
 * Define la clase CrearCuenta que extiende de javax.swing.JFrame, que representa la ventana para crear una cuenta.
...
public class CrearCuenta extends javax.swing.JFrame {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (!checkAhorro.isSelected() && !checkCredito.isSelected() && !checkDebito.isSelected()){
            JOptionPane.showMessageDialog(null, "Seleccione el tipo de cuenta por favor", "Error", JOptionPane.INFORMATION_MESSAGE);
            ...
            JOptionPane.showMessageDialog(null, "Seleccione solo un tipo de cuenta por favor", "Error", JOptionPane.INFORMATION_MESSAGE);
        }
    ...
    public void siguientepaso(String tipoCuenta){
        ...
        if (!checkBolivianos.isSelected() && !checkDolares.isSelected()){
            JOptionPane.showMessageDialog(null, "Seleccione que tipo de moneda guardará su cuenta", "Error", JOptionPane.INFORMATION_MESSAGE);
        } else {
            ...
            if(checkBolivianos.isSelected() && !checkDolares.isSelected()){
                ...
                if (ahorro && !credito && !debito || !ahorro && credito && !debito || !ahorro && !credito && debito){
                    if(bolivianos && !dolares || !bolivianos && dolares){
                        ...
                        Menu ventana = new Menu(usuario, numerCuenta); // Instancia de la clase Menu
                ...
                JOptionPane.showMessageDialog(null, "Seleccione solo un tipo de moneda por favor", "Error", JOptionPane.INFORMATION_MESSAGE);
            }
        }
    }
