 ...
 */
/**
 * Define la clase CrearCuentaIngles que extiende de javax.swing.JFrame, que representa la ventana para crear una cuenta.
            ...
            if(checkBolivianos.isSelected() && !checkDolares.isSelected()){
                ...
                if (ahorro && !credito && !debito || !ahorro && credito && !debito || !ahorro && !credito && debito){
                    if(bolivianos && !dolares || !bolivianos && dolares){
                        ...
                        MenuIngles ventana = new MenuIngles(usuario, numerCuenta); // Instancia de la clase Menu
