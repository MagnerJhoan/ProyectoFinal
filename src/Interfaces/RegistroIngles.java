 ...
 */
/**
 * Clase RegistroIngles que representa la interfaz de registro de usuarios.
 */
public class RegistroIngles extends javax.swing.JFrame {
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        if (!txtNombre.getText().equals("") && !txtCi.getText().equals("") && !txtDireccion.getText().equals("") && !txtApellido.getText().equals("") && !txtUsuario.getText().equals("") && !txtTelefono.getText().equals("") && !txtContraseña.getText().equals("")) {
            if (!existeUsuario(txtUsuario.getText())) { // Verifica si el usuario ya existe
                ...
                CuentasIngles cuentas = new CuentasIngles(txtUsuario.getText()); // Crea una instancia de la interfaz Cuentas
                ...
                JOptionPane.showMessageDialog(null, "The user already exists ", "Error", JOptionPane.INFORMATION_MESSAGE); // Muestra un mensaje de error si el usuario ya existe
            }
        } else {
            JOptionPane.showMessageDialog(null, "Please complete all fields.", "Error", JOptionPane.INFORMATION_MESSAGE); // Muestra un mensaje de error si no se completan todos los campos
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        IngresoPinIngles ventana = new IngresoPinIngles(); // Crea una instancia de la interfaz IngresoPin
