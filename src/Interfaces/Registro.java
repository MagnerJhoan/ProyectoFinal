...
public class Registro extends javax.swing.JFrame {
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        if (!txtNombre.getText().equals("") && !txtCi.getText().equals("") && !txtDireccion.getText().equals("") && !txtApellido.getText().equals("") && !txtUsuario.getText().equals("") && !txtTelefono.getText().equals("") && !txtContraseña.getText().equals("")) {
            if (!existeUsuario(txtUsuario.getText())) { // Verifica si el usuario ya existe
                ...
                Cuentas cuentas = new Cuentas(txtUsuario.getText()); // Crea una instancia de la interfaz Cuentas
                ...
                JOptionPane.showMessageDialog(null, "El usuario ya existe ", "Error", JOptionPane.INFORMATION_MESSAGE); // Muestra un mensaje de error si el usuario ya existe
            }
        } else {
            JOptionPane.showMessageDialog(null, "Complete todos los campos por favor", "Error", JOptionPane.INFORMATION_MESSAGE); // Muestra un mensaje de error si no se completan todos los campos
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        IngresoPin ventana = new IngresoPin(); // Crea una instancia de la interfaz IngresoPin
